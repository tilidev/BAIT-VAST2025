  ...
  data() {
    return {
      ...
      layout: [
        ...
        { x: 0, y: 0, w: 3, h: 11, i: '6', component: 'GraphView', props: { filterKey: 'jo' } },
        { x: 3, y: 0, w: 3, h: 11, i: '7', component: 'GraphView', props: { filterKey: 'fi' } },
        { x: 6, y: 0, w: 3, h: 11, i: '8', component: 'GraphView', props: { filterKey: 'tr' } },
