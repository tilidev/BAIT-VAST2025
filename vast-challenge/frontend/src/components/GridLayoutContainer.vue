  ...
  <div>
    ...
    <div class="flex space-x-4 mb-4">
      <div @drag="drag" @dragend="dragend" class="droppable-element" draggable="true" unselectable="on"
        data-component-type="GraphView">Drag Graph View</div>
      <div @drag="drag" @dragend="dragend" class="droppable-element" draggable="true" unselectable="on"
        data-component-type="GeoJsonMap">Drag GeoJSON Map</div>
    </div>
    <div id="content">
      <GridLayout :ref="setLayoutRef" v-model:layout="layout" :col-num="colNum" :row-height="30" :is-draggable="true"
